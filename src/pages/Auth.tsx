...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:w-[40%] bg-[#111111] flex items-center justify-center p-8 relative">
        ...
        >
          {/* Tab switcher */}
          <div className="flex rounded-full bg-[#1A1A1A] p-1 mb-8">
            {[
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-1" style={{ letterSpacing: -0.5 }}>
                {isSignUp ? 'Comece gratuitamente' : 'Bem-vindo de volta'}
              </h2>
              <p className="text-[#7C6EF5] text-sm mb-6">
                {isSignUp
                  ? 'Crie sua conta e configure seu negócio'
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {isSignUp && (
                  <div className="space-y-1.5">
                    <Label className="text-[#ccc] text-sm">Nome do negócio</Label>
                    <div className="relative">
                      <Building2 className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#555]" />
                      <Input
                        value={businessName}
                        onChange={(e) => setBusinessName(e.target.value)}
                        placeholder="Studio Bella"
                        className="pl-10 bg-[#1A1A1A] border-[#333] text-white placeholder:text-[#555] focus:border-[#7C6EF5]"
                      />
                    </div>
                  </div>
                )}
                <div className="space-y-1.5">
                  <Label className="text-[#ccc] text-sm">E-mail</Label>
                  <div className="relative">
                ...
                <div className="space-y-1.5">
                  <Label className="text-[#ccc] text-sm">Senha</Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      minLength={6}
                      className="pl-10 pr-10 bg-[#1A1A1A] border-[#333] text-white placeholder:text-[#555] focus:border-[#7C6EF5]"
                    />
                    <button
                      type="button"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full py-3 rounded-lg bg-[#7C6EF5] text-white font-medium flex items-center justify-center gap-2 transition-opacity disabled:opacity-50 hover:bg-[#6B5EE0]"
                >
              ...
              {!isSignUp && (
                <button className="text-[#7C6EF5] text-sm mt-4 hover:underline">
                  Esqueceu sua senha?
                </button>
              )}
              ...
              {isSignUp && (
                <p className="text-[#666] text-xs mt-4 text-center">
                  ...
                  <span className="text-[#7C6EF5] hover:underline cursor-pointer">Termos de Uso</span>
                  {' '}e{' '}
                  <span className="text-[#7C6EF5] hover:underline cursor-pointer">Política de Privacidade</span>
                </p>
              )}
            </motion.div>
          </AnimatePresence>
